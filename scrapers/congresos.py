...
CONGRESOS: list[tuple[str, str, str]] = [
    ...
    ("CAMP", "Congreso de Campeche", "https://www.congresocam.gob.mx/"),
    ...
    ("COAH", "Congreso de Coahuila", "https://www.congresocoahuila.gob.mx/coahuila/"),
    ...
    ("HGO", "Congreso de Hidalgo", "https://congresohidalgo.gob.mx/"),
