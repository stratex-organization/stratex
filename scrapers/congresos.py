...
CONGRESOS: list[tuple[str, str, str]] = [
    ...
    ("CHIS", "Congreso de Chiapas", "https://congresochiapas.gob.mx/"),
    ...
    ("GRO", "Congreso de Guerrero", "https://congresogro.gob.mx/"),
    ...
    ("MICH", "Congreso de Michoacán", "https://congresomich.gob.mx/"),
    ("MOR", "Congreso de Morelos", "https://congresomorelos.gob.mx/"),
    ("NAY", "Congreso de Nayarit", "https://www.congresonayarit.mx/"),
